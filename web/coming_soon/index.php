	...
	<section class="container main-wrapper">
		...
		<section id="logo" class="fade-down">
			<a href="#" title="UX - Coming Soon HTML Template">
            	<img width="200px" src="img/logo_woutw.svg" alt="Logo WhalEAT">
            </a>
		</section>
		<!-- Logo end here -->
		<!-- Slogan start here -->
		<section class="slogan fade-down">
			<h1>Website Whal<strong><span style="text-weight:bold; color:#fb1a6b">EAT</span></strong> is under construction. We`ll be here soon with our new awesome site, subscribe to be notified.</h1>
		</section>
		<!-- Slogan end here -->
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content pop-up pop-up-cnt">
        ...
        if(isset($_POST['submit'])){
        	...
        	$to="xavi.sanchez.mir@gmail.com"; // Add your e-mail here
        	if($code!=$captcha){
        ...
        <div class="clearfix cnt-wrap">
          <div class="col-md-6 col-sm-6">
            ...
            <h4>Phone</h4>
            <p>Mobile: (0034) 669 510 811</p>
          </div>

          <div class="col-md-6 col-sm-6">
            <i class="fa fa-envelope-o"></i>
            <h4>Email</h4>
            <p>xavi.sanchez.mir@gmail.com<br />djlakh@gmail.com</p>
          </div>
        </div>
      </div>
    </div>
